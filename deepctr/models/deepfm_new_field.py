...
from ..layers.interaction import FM, BiInteractionPooling
from ..layers.utils import concat_func, add_func, combined_dnn_input


def DeepFM_new(linear_feature_columns, dnn_feature_columns, fm_group=(DEFAULT_GROUP_NAME,), dnn_hidden_units=(256, 128, 64),
           l2_reg_linear=0.00001, l2_reg_embedding=0.00001, l2_reg_dnn=0, seed=1024, dnn_dropout=0,
           dnn_activation='relu', dnn_use_bn=False, task='binary',bi_dropout=0):
